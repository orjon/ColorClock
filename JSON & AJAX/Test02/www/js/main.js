...
function sendTime()    //update Adruino unsin AJAX
     {
    // var pickedColor = color.options[color.selectedIndex];
    var url = "/arduino/" + timeString;
  ...
  var draggableIndicators = Draggable.create("#indicatorRotator", {
    ...
    onRelease: function(){
      ...
      var JSONtime = '{ "time":"' + timeString + '" }';
      console.log('Uploaded JSON: ' + JSONtime);
      var obj = JSON.parse(JSONtime);
      sendTime();
    }
  });
